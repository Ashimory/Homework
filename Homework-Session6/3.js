...
// 3.1. Object
// 3.2. Array
// 3.3. Solution 1: by going through the entire object, then the "hits" array, then the "hit" itself which is another object ( for example, jobSearch.hits[1].title)
// Solution 2: destructure the "jobSearch" object, then the "hits" array, then each "hit" object